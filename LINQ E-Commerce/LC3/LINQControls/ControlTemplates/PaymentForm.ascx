<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PaymentForm.ascx.cs" Inherits="LINQControls_ControlTemplates_PaymentForm" %>
<%@ Register assembly="Telerik.Web.UI" namespace="Telerik.Web.UI" tagprefix="telerik" %>
        ...
        <style type="text/css">
            ...
            .style2
            {
               ...
               <h3><asp:Label ID="ErrorLabel" ForeColor="Red" runat="server" ></asp:Label></h3>
...
<CollapseAnimation Type="OutQuint" Duration="200"></CollapseAnimation>
            ...
            <tr>
                <td>
                    E-Mail Address:</td>
                <td colspan="2">
                    <telerik:RadTextBox ID="BillEMail" Runat="server" Skin="Vista">
                    </telerik:RadTextBox>
                </td>
                <td>
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" 
                        ControlToValidate="BillEMail" ErrorMessage="Please enter a valid e-mail." 
                        ToolTip="Please enter a valid e-mail." 
                        ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*">*</asp:RegularExpressionValidator>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator20" runat="server" 
                        ControlToValidate="BillEMail" ErrorMessage="Please enter an e-mail address." 
                        ToolTip="Please enter an e-mail address.">*</asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td>
                    Company:</td>
                <td colspan="2">
                    <telerik:RadTextBox ID="BillCompany" Runat="server" Skin="Vista">
                    </telerik:RadTextBox>
                </td>
                <td>
                    &nbsp;</td>
...
<CollapseAnimation Type="OutQuint" Duration="200"></CollapseAnimation>
            ...
            <%--Uncomment for vat and PO info--%>
            <%--<tr>
                <td>
                    Purchase lc_Order # (optional)</td>
                <td colspan="2">
                    <telerik:RadTextBox ID="RadTextBox1" Visible="false" Runat="server" Skin="Vista">
                    </telerik:RadTextBox>
                </td>
                <td>
                    &nbsp;</td>
            ...
            <tr>
                <td>
                   <asp:Label ID="Label1" runat="server" Text="VAT ID (for EU countries only)"></asp:Label></td>
                <td colspan="2">
                    <telerik:RadTextBox ID="RadTextBox2" Visible="false" Runat="server" Skin="Vista">
                    </telerik:RadTextBox>
                    <br />
                  <asp:Label ID="VatIDLabel" runat="server" Visible="false" Text="Do not include the 2-letter prefix of you VAT ID number."></asp:Label>
                </td>
                <td>
                    &nbsp;</td>
            </tr>--%>
            <tr>
                <td>
                    Type of Card:</td>
                <td colspan="2">
                    <telerik:RadComboBox ID="TypeCardDropDown" Runat="server" Skin="Vista">
                        <Items>
                            ...
                            <telerik:RadComboBoxItem runat="server" Text="MasterCard" 
                                Value="MasterCard" />
                            <telerik:RadComboBoxItem runat="server" Text="Visa" 
                                Value="Visa" />
                            <telerik:RadComboBoxItem runat="server" Text="Discover" 
                                Value="Discover" />
                        </Items>
<CollapseAnimation Type="OutQuint" Duration="200"></CollapseAnimation>
                    </telerik:RadComboBox>
                ...
                <td>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator15" runat="server" 
                        ControlToValidate="TypeCardDropDown" Display="Dynamic" 
                        ErrorMessage="Please select a credit card type" InitialValue="..">*</asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td colspan="2">
                    <telerik:RadTextBox ID="CreditCardNumberTextBox" Runat="server" 
                        Skin="Vista">
                    </telerik:RadTextBox>
                </td>
                <td>
                    <asp:RequiredFieldValidator ID="CreditCardNumberValidator" runat="server" 
                        ControlToValidate="CreditCardNumberTextBox" Display="Dynamic" 
                        ErrorMessage="Please enter a credit card number." 
                        ToolTip="Please enter a credit card number.">*</asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td>
                    CVC (Credit Card Verification Code):</td>
                <td colspan="2">
                    <telerik:RadTextBox ID="CVCTextBox" Runat="server" Skin="Vista">
                    </telerik:RadTextBox>
                </td>
                <td>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator17" runat="server" 
                        ControlToValidate="CVCTextBox" ErrorMessage="Please enter a CVC" 
                        ToolTip="Please enter a CVC">*</asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td>
                    Expiration Date:</td>
                <td class="style1">
                    <telerik:RadComboBox ID="MonthDropDown" Runat="server" Skin="Vista" 
                        Width="50px">
                        <Items>
                            <telerik:RadComboBoxItem runat="server" Selected="True" Text=".." Value=".." />
...
<CollapseAnimation Type="OutQuint" Duration="200"></CollapseAnimation>
                ...
                <td class="style2">
                     <telerik:RadComboBox ID="YearDropDown" Runat="server" Skin="Vista" Width="50px">
                         <Items>
                             <telerik:RadComboBoxItem runat="server" Selected="True" Text=".." Value=".." />
                             <telerik:RadComboBoxItem runat="server" Text="09" Value="09" />
                             <telerik:RadComboBoxItem runat="server" Text="10" Value="10" />
...
<CollapseAnimation Type="OutQuint" Duration="200"></CollapseAnimation>
                ...
                <td>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator18" runat="server" 
                        ControlToValidate="MonthDropDown" ErrorMessage="Please select a month." 
                        ToolTip="Please select a month.">*</asp:RequiredFieldValidator>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator19" runat="server" 
                        ControlToValidate="YearDropDown" Display="Dynamic" 
                        ErrorMessage="Please select a year." ToolTip="Please select a year.">*</asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td>
...
<CollapseAnimation Type="OutQuint" Duration="200"></CollapseAnimation>
            ...
            <tr>
                <td>
                    E-Mail Address:</td>
                <td>
                    <telerik:RadTextBox ID="ShipEMail" Runat="server" Skin="Vista">
                    </telerik:RadTextBox>
                </td>
                <td>
                    &nbsp;</td>
            ...
            <tr>
                <td>
                    Company:</td>
                <td>
                    <telerik:RadTextBox ID="ShipCompany" Runat="server" Skin="Vista">
                    </telerik:RadTextBox>
                </td>
                <td>
                    &nbsp;</td>
...
<CollapseAnimation Type="OutQuint" Duration="200"></CollapseAnimation>
    ...
    <asp:CheckBox ID="BillShipCheck" runat="server" 
     ...
     <asp:Button ID="btnSubmit" runat="server" Text="Submit" 
        ...
        <br />
        <asp:Button ID="PayPalButton" runat="server" onclick="PayPalButton_Click" 
            Text="PayPal Submit" />
