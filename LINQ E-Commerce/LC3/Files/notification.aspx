...
<script runat="server" language="c#">
  ...
  void Page_Load(Object sender, EventArgs e) {
    ...
    switch (EncodeHelper.GetTopElement(RequestXml)) {
      case "new-lc_Order-notification":
        NewOrderNotification N1 = (NewOrderNotification) EncodeHelper.Deserialize(RequestXml, typeof(NewOrderNotification));
        string lc_OrderNumber1 = N1.googleordernumber;
        string BuyerEMail = N1.buyerbillingaddress.email;
        ...
        LinqCommerce.LinqOrderAccess lo = new LinqCommerce.LinqOrderAccess();
        lo.CompleteOrder(Convert.ToInt16(ThisItem.merchantitemid), 0, "");
        //empty user cart
        LinqCommerce.LinqShoppingCartAccess ls = new LinqCommerce.LinqShoppingCartAccess();
      ...
      case "risk-information-notification":
        ...
        // This notification tells us that Google has authorized the lc_Order and it has passed the fraud check.
        // Use the data below to determine if you want to accept the lc_Order, then start processing it.
        string lc_OrderNumber2 = N2.googleordernumber;
        ...
        break;
      case "lc_Order-state-change-notification":
        ...
        // The lc_Order has changed either financial or fulfillment state in Google's system.
        string lc_OrderNumber3 = N3.googleordernumber;
      ...
      case "charge-amount-notification":
        ...
        string lc_OrderNumber4 = N4.googleordernumber;
      ...
      case "refund-amount-notification":
        ...
        string lc_OrderNumber5 = N5.googleordernumber;
