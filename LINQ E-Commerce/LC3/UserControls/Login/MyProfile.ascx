<%@ Control Language="C#" AutoEventWireup="true" CodeFile="MyProfile.ascx.cs" Inherits="UserControls_Login_MyProfile" %>
<%@ Register assembly="Telerik.Web.UI" namespace="Telerik.Web.UI" tagprefix="telerik" %>
<div>
<table>
            <tr>
                <td colspan="2">
                    <asp:Label ID="lblTitle" runat="server" Text="My Information" 
            ...
            <tr>
                ...
                <td>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                        ...
                        ToolTip="First Name Required">*</asp:RequiredFieldValidator>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;</td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                        ControlToValidate="BillLNTB" ErrorMessage="Last Name Required" 
                        ToolTip="Last Name Required">*</asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
             ...
             <tr>
                <td>
                    E-Mail:</td>
                <td>
                    <telerik:RadTextBox ID="EMailTB" Runat="server" Skin="Vista">
                    </telerik:RadTextBox>
                </td>
                <td>
                    &nbsp;</td>
            ...
            <tr>
                ...
                <td>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" 
                        ...
                        ErrorMessage="Address Required" ToolTip="Address Required">*</asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                ...
                <td>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" 
                        ...
                        ErrorMessage="City Required" ToolTip="City Required">*</asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                ...
                <td>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" 
                        ...
                        ErrorMessage="Phone Required" ToolTip="Phone Required">*</asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td>
